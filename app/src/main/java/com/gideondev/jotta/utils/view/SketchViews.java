...
public class SketchViews extends View implements OnTouchListener {
  ...
  public SketchViews(Context context, AttributeSet attr) {
    super(context, attr);
  ...
  public boolean onTouch(View arg0, MotionEvent event) {
    ...
    switch (event.getAction()) {
      ...
      case MotionEvent.ACTION_UP:
        ...
        break;
      default:
        Log.e("error", "Wrong element choosen: " + event.getAction());
    }
    return true;
  }
  ...
  public void setSize(int size, int eraserOrStroke) {
    switch (eraserOrStroke) {
      ...
      case ERASER:
        ...
        break;
      default:
        Log.e("error", "Wrong element choosen: " + eraserOrStroke);
    }
