...
import com.gideondev.jotta.databinding.ItemMoveToNoteFolderBinding;
...
public class MoveToFolderAdapter
    extends RecyclerView.Adapter<MoveToFolderAdapter.RecyclerViewHolder>  {
    ...
    ItemMoveToNoteFolderBinding binding;

    public MoveToFolderAdapter(Context context, List<FolderModel> folde, FolderListner listener) {
        mContext = context;
    ...
    @Override
    public MoveToFolderAdapter.RecyclerViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        binding= DataBindingUtil.inflate(inflater, R.layout.item_move_to_note_folder, parent, false);
        // set the view's size, margins, paddings and layout parameters
       // binding.setCallback(projectClickCallback);
        return new MoveToFolderAdapter.RecyclerViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(MoveToFolderAdapter.RecyclerViewHolder holder, int position) {
    ...
    static class RecyclerViewHolder
        ...
        private ItemMoveToNoteFolderBinding mBinding;

        public RecyclerViewHolder(ItemMoveToNoteFolderBinding binding) {
